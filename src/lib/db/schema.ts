...
export const maintenanceLogStatusEnum = pgEnum(
	'maintenance_log_status',
	enumToPgEnum(MaintenanceLogStatus)
);
...
export const maintenanceLogs = pgTable('maintenance_logs', {
	...
	cost: decimal('cost'),
	dateLogged: timestamp('date_logged', { precision: 3, mode: 'string', withTimezone: true })
		.defaultNow()
		.notNull(),
...
export const expenses = pgTable('expenses', {
	...
	date: timestamp('date', { precision: 3, mode: 'string', withTimezone: true })
		.defaultNow()
		.notNull(),
